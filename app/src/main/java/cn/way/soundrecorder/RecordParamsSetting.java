...
import cn.way.soundrecorder.ext.IQualityLevel;
 ...
 *     author: Way Lin
 *     date  : 2018.04.15
 *     desc  : We use this class to do operations related with record params.
...
public class RecordParamsSetting {
    ...
    public static RecordParams getRecordParams(String requestType, int selectFormat, int selectMode,
                                               boolean[] selectEffect, Context context) {
        LogUtil.i(TAG, "<getRecordParams> start");
            ...
            if (OptionsUtil.isAACEncodeSupport()) {
                switch (selectFormat) {
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        LogUtil.e(TAG, "<getRecordParams> selectFormat is out of range");
                        break;
                }
            } else {
                 ...
                 */
                LogUtil.i(TAG, "<getRecordParams>, use default Encoder: AMR.");
        ...
        LogUtil.i(TAG, "recordParams.mAudioEncoder is:" + recordParams.mAudioEncoder
        ...
        LogUtil.i(TAG, "<getRecordParams> end");
        return recordParams;
    }

    public static boolean canSelectFormat() {
        // M: Modify to use AAC encoder and remove the AMR and VORBIS
        LogUtil.i(TAG, "<canSelectFormat> FeatureOption.HAVE_AACENCODE_FEATURE is:"
    ...
    public static boolean isAvailableRequestType(String requestType) {
    ...
    public static int[] getModeStringIDArray() {
    ...
    public static String[] getFormatStringArray(Context context) {
        ...
        if (OptionsUtil.isAACEncodeSupport()) {
            ...
            LogUtil.e(TAG, "<dlgChooseChannel> No featureOption enable");
        }
        return formatStrings;
    }

    public static int[] getEffectStringIDArray() {
        return sEffectArray;
    }

    public static int getSelectFormat(int which) {
        return sFormatArray[which];
    }

    public static int getSelectMode(int which) {
        if (sModeArray == null) {
    ...
    public static void initRecordParamsSharedPreference(Context context) {
        LogUtil.i(TAG, "<InitSharedPreference>");
        ...
        LogUtil.i(TAG, "isFirstSet is:" + isFirstSet);
        if (isFirstSet) {
            LogUtil.i(TAG, "It is the first time to set default values.");
    ...
    static void setExtensionAndMimeTypeParams(RecordParams recordParams) {
        LogUtil.i(TAG, "<setExtensionAndMimeTypeParams>");
        ...
        LogUtil.i(TAG, "recordParams.mExtension is:" + recordParams.mExtension
