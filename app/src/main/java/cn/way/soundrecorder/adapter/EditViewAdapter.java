package cn.way.soundrecorder.adapter;
 ...
 *     author: Way Lin
 *     date  : 2018.04.15
 *     desc  : the adapter of list view in RecordingFileList.
 * </pre>
 */
...
public class EditViewAdapter extends BaseAdapter {
     ...
     * @param idList       a list of file id
     ...
     */
    public void setCheckBox(int id, boolean checked) {
    ...
    public List<Integer> getCheckedPosList() {
        ...
        for (int i = 0; i < listSize; i++) {
            ...
            if (state && !mCheckedItemId.contains(curPos)) {
                LogUtil.i(TAG, "<getCheckedPosList>, curPos is:" + curPos);
    ...
    public ArrayList<String> getCheckedItemsList() {
        ...
        for (int i = 0; i < listSize; i++) {
            ...
            int curPos = mCheckStates.keyAt(i);
            if (state) {
                LogUtil.i(TAG, "<getCheckedItemsList>, curPos is:" + curPos);
    ...
    public long getItemId(int position) {
        long id = mIdList.get(position);
        mIdPos.put((int) id, position);
        return id;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == editListItemView) {
            editListItemView = mInflater.inflate(R.layout.list_item_editor, null);
        ...
        String fileName = mNameList.get(position);
    ...
    public void initEditViewAdapter(Context context, List<String> nameList, List<String> pathList,
        ...
        for (int pos = 0; pos < mIdList.size(); pos++) {
            ...
            LogUtil.i(TAG, "The recordId is:" + itemId + "; pos is:" + pos);
        }
    }
